...
class SkillFragment : Fragment(){
    ...
    private fun addDataToList() {
        ...
        langList.add(SkillData("C++", R.drawable.c))
        langList.add(SkillData("Swift", R.drawable.swift))
        langList.add(SkillData("Dart", R.drawable.dart))
    ...
    private fun navigateToDetail(extraName: String){
        findNavController().navigate(SkillFragmentDirections.actionNavigationSkillToNavigationSkillDetail(extraName))
    }
